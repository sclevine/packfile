module github.com/sclevine/packfile
...
require (
	...
	github.com/buildpack/lifecycle v0.3.1-0.20190813145040-357067a48b7e // indirect
	...
	k8s.io/apimachinery v0.0.0-20190814100815-533d101be9a6 // indirect
)
